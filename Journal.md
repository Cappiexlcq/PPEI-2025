...
Nous avons exploité les données présentes dans le dossier "archive-49" . Dans le cours précédent, nous avions créé une arborescence des différents documents en dossier : img, docs, ann, txt, qui eux, sont classés par année ou par lieu. 
...
Si on utilise cat puis un for, les éléments sont séparés par des espaces, ces espaces peuvent poser un problème dans le for car ils comptent pour des séparateurs de mots. 
...
Nous avons corrigé le script du mini projet 1. Il ne faut pas hésiter à utiliser man curl pour chercher des commandes. Nous avons parler du HTML, comment il dialogue avec internet, à quoi sert lynx, comment utiliser wget. Nous avons vu coment créer un tableau en HTML avec table, tr, th, comment ouvrir et fermer les balises etc. Nous devons faire un mini projet 2 en transformant notre script pour qu'il puisse sortir un HTML.

## Mercredi 12 novembre 

Nous avons corrigé le script du mini projet 2. Nous avons vu comment styliser du HTML avec CSS. J'en ai profité pour m'occuper enfin de mes dossiers inutles DS Store et Icon. Je vais mettre à jour mon travail ce soir. Je dois envoyer mon script avec le CSS. 